class TransaksiModel {
  ...
  TransaksiModel({this.isSuccess, this.message, this.data, this.error});
  ...
  TransaksiModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DataTransaksi>[];
      json['data'].forEach((v) {
        data!.add(new DataTransaksi.fromJson(v));
      });
    }
  }
  factory TransaksiModel.withError(String error) => TransaksiModel(error: error);
