class ListDetail {
  ...
  ListDetail({this.isSuccess, this.message, this.data, this.error});
  ...
  ListDetail.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DataKebun>[];
      json['data'].forEach((v) {
        data!.add(new DataKebun.fromJson(v));
      });
    }
  }
  factory ListDetail.withError(String error) => ListDetail(error: error);
...
class DataKebun {
  ...
  DataKebun.fromJson(Map<String, dynamic> json) {
    id = json['id'];
